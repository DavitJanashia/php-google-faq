...
<?php
    ...
    //
    // var_dump($posts);
    // var_dump(is_numeric($ciao));

    $allText =
    "How are you implementing the recent Court of Justice of the European Union (CJEU) decision on the right to be forgotten? /.M./
    ...
    When you search for a name, you may see a notice that says that results may have been modified in accordance with data protection law in Europe. We’re showing this notice in Europe when a user searches for most names, not just pages that have been affected by a removal. /.M./
    How does Google protect my privacy and keep my information secure? /.M./
